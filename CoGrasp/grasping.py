...
# create mug asset
# mug_asset_file = "urdf/ycb_old/025_mug/poisson/025_mug.urdf"
...
object_graspnet_pred = {'banana': [], 'orange': [], 'mug': [], 'bowl': [], 'apple': []}
object_pruned_pred = {'banana': [], 'orange': [], 'mug': [], 'bowl': [], 'apple': []}
            ...
            if grasp_idx < total_grasps:
                ...
                if dof_result:
                    ...
                    if end_state_collision:
                        ...
                        simulation_result_file = "/home/kaykay/isaacgym/python/contact_graspnet/SimulationResults/Real/{}_{}.npy".format(objects[object_idx], uuid.uuid4().hex)
